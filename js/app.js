...
// Инициализируем объект с данными
    var data = { instrument: [
        ...
        /* =========== эксцентриковая шлифмашина ==================*/
        {
            ...
            modelInstr: 'BO5041',
            description:[
                'частота вращения диска от 4000 до 12000 об/мин',
                'Потребляемая мощность (Вт)	300',
                'диаметр диска до 125 мм',
                'ход платформы 2.8 мм',
                'Вес	1.4 кг',
                'Регулировка скорости'
            ],
            image: 'img/Bo5041.jpg',
            price: "10",
            price2: "15"
        },
       ...
       /* {
        ...
        /* =========== Сабельная пила ==============*/
        {
            ...
            description:[
                'Мощность: 1510 Вт',
                'Число ходов полотна в минуту: 2800',
        ...
        /* =========== детектор проводки ==============*/
        {
            nameInstr: 'Детектор проводки',
            brandInstr: 'BOSCH',
            modelInstr: 'DMF-10',
            description:[
                "Цифровой детектор для обнаружения и локализации проводки, металлов (включая цветные) и деревянных внутренних конструкций. Функция «Zoom». 5-сегментный дисплей с высоким разрешением. Однозначное запрещение/разрешение сверления с помощью светодиодного индикатора. Автоматическая калибровка."
            ],
            image: 'img/bosch_dmf_10.jpg',
            price: "5",
            price2: "8"
        },
        /*============= Бензопилы =====================*/
        ...
        /*============= Мойка =====================*/
        {
            nameInstr: 'Мойка высокого давления',
            brandInstr: 'Husqvarna',
            modelInstr: 'PW 125',
            description:[
                'Мощность 1.5 кВт',
                'Производительность 460 л/ч',
                'Максимальное рабочее давление 96 бар',
