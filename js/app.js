...
// Инициализируем объект с данными
    var data = { instrument: [
        ...
        /* =========== эксцентриковая шлифмашина ==================*/
        {
            ...
            modelInstr: 'BO5041',
            description:[
                'частота вращения диска до 4000-12000 об/мин',
        ...
        /*============= Мойка =====================*/
        {
            ...
            description:[
                'Мощность 1.5 кВт',
                'Максимальное давление 125 бар',
                'Расход воды 320–460 л/час',
                'Длина шланга	7 метров',
                'Вес 7 кг'
            ],
            image: 'img/PW125.jpg',
            price: "15"
